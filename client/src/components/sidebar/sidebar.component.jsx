...
// import img && scss
import {
  me, info, badge_silver_blank, badge_gold_blank, badge_sapphire, badge_locked,
  duo_sleeping, treasure, achievementImg, facebook, instagram, twitter,
} from "../../img";
        ...
        <div className={style.overall__trophy}>
          ...
          <div className={style.overall__process}>
            ...
            <div className={style["overall__process-detail"]}>
              <span></span>
              <span>{achievement.kn}/10 KN</span>
            </div>
          </div>
        </div>
      ...
      <div className={style.achievement}>
        ...
        <div className={style.achievement__trophy}>
          <div className={style["achievement__trophy-item"]}>
            <img src={achievementImg} alt="achievement"></img>
            <span>Cấp 6</span>
          </div>
          <div className={style.achievement__process}>
            ...
            <div className={style["achievement__process-detail"]}>
              <span></span>
              <span>{achievement.totalKn}/100</span>
            </div>
          </div>
        </div>
      </div>
